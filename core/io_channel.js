				...
				module.exports = function (url) {
						...
						ch.upgrade = function (req, sock, head) {
								...
								function head() {
										...
										if (w > h.length) {
												return err('unexpected data in header' + se + s.toString());
										}
										return e != 0;
								}
								function data() {
								...
								function mask() {
										...
										e = l;
										if (l > max) {
												return err('buffer size request too large ' + l + ' > ' + max);
										}
										if (l > o.length) {
												o = new Buffer(l);
										}
